...
const createSupplier = (data: any) => request.post("/createSupplier", data) as Promise<ResponseData>;

const creatVisit = (data: any) => request.post("/creatVisit", data) as Promise<ResponseData>;
const getVisit = (data: any) => request.get("/getVisit", data) as Promise<MessageAPi>;

const countrys = (data: any) => request.get("/countrys", data) as Promise<MessageAPi>;

const sendEmail = (data: any) => request.post("/sendEmail", data) as Promise<ResponseData>;
